...
| **Lỗ hổng giả định** | Buffer overflow do đọc input vượt quá kích thước buffer (`read` với độ dài cố định lớn hơn buffer), cho phép ghi đè return address trên stack. |
